    ...
    return `<svg class="dw-login-mark" viewBox="0 0 280 280" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        ...
        <filter id="groove-wobble-login" x="-4%" y="-4%" width="108%" height="108%">
          <feTurbulence type="fractalNoise" baseFrequency="0.018 0.035" numOctaves="2" seed="23" result="noise"/>
          <feDisplacementMap in="SourceGraphic" in2="noise" scale="0.32" xChannelSelector="R" yChannelSelector="G"/>
        </filter>
