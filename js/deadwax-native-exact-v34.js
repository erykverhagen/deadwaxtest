...
(() => {
  ...
  function dwLoginMark(){
    return `<svg class="dw-login-mark" viewBox="0 0 280 280" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <circle cx="140" cy="140" r="134" fill="none" stroke="#0b0906" stroke-width="1.9"/><circle cx="140" cy="140" r="131" fill="none" stroke="#c88020" stroke-width="0.8"/>
      <circle cx="140" cy="140" r="128" fill="none" stroke="#0b0906" stroke-width="1.9"/><circle cx="140" cy="140" r="125" fill="none" stroke="#c07a1c" stroke-width="0.8"/>
      <circle cx="140" cy="140" r="122" fill="none" stroke="#0b0906" stroke-width="1.8"/><circle cx="140" cy="140" r="119" fill="none" stroke="#b87618" stroke-width="0.8"/>
      <circle cx="140" cy="140" r="116" fill="none" stroke="#0b0906" stroke-width="1.8"/><circle cx="140" cy="140" r="113" fill="none" stroke="#b07218" stroke-width="0.7"/>
      <circle cx="140" cy="140" r="110" fill="none" stroke="#0b0906" stroke-width="1.7"/><circle cx="140" cy="140" r="107" fill="none" stroke="#a86e16" stroke-width="0.7"/>
      <circle cx="140" cy="140" r="104" fill="none" stroke="#0b0906" stroke-width="1.7"/><circle cx="140" cy="140" r="101" fill="none" stroke="#a06a14" stroke-width="0.7"/>
      <circle cx="140" cy="140" r="98" fill="none" stroke="#0b0906" stroke-width="1.6"/><circle cx="140" cy="140" r="95" fill="none" stroke="#986614" stroke-width="0.7"/>
      <circle cx="140" cy="140" r="92" fill="none" stroke="#0b0906" stroke-width="1.6"/><circle cx="140" cy="140" r="89" fill="none" stroke="#906212" stroke-width="0.7"/>
      <circle cx="140" cy="140" r="86" fill="none" stroke="#0b0906" stroke-width="1.5"/><circle cx="140" cy="140" r="83" fill="none" stroke="#886010" stroke-width="0.7"/>
      <circle cx="140" cy="140" r="80" fill="none" stroke="#0b0906" stroke-width="1.15"/><circle cx="140" cy="140" r="77" fill="none" stroke="#806010" stroke-width="0.5"/>
      <circle cx="140" cy="140" r="74" fill="none" stroke="#0b0906" stroke-width="0.95"/><circle cx="140" cy="140" r="71" fill="none" stroke="#76580f" stroke-width="0.42"/>
      <circle cx="140" cy="140" r="68" fill="none" stroke="#0b0906" stroke-width="0.8"/><circle cx="140" cy="140" r="65" fill="none" stroke="#6e520e" stroke-width="0.36"/>
      <circle cx="140" cy="140" r="62" fill="none" stroke="#0b0906" stroke-width="0.65"/>
